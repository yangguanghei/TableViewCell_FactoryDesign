...
//    BaseTableViewCell *cell = [[NSClassFromString(cell_Name) alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:model_Name];
    return cell;
